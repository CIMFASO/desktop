#include "uifactureslistview2.h"
#include "ui_uifactureslistview2.h"
#include "utils/prixformat.h"

UIFacturesListView2::UIFacturesListView2(QWidget *parent) :
    QDialog(parent),
    ui(new Ui::UIFacturesListView2)
{
    ui->setupUi(this);
    ...
    connect(delegate,&CustomDelegate::btn1Clicked,this,&UIFacturesListView2::slotValider);
    connect(delegate,&CustomDelegate::btn2Clicked,this,&UIFacturesListView2::slotRejeter);
    connect(crud->getHttpObject(),&HttpRequest::requestSuccess,this,&UIFacturesListView2::httpResponse);
}

UIFacturesListView2::~UIFacturesListView2()
{
    delete ui;
}

int UIFacturesListView2::getStatutBL()
{
...
void UIFacturesListView2::on_facturesLineEdit_textChanged(const QString &arg1)
{
...
void UIFacturesListView2::httpResponse(QMap<QString, QByteArray> response)
{
...
void UIFacturesListView2::slotValider(const QModelIndex &index)
{
    QString s;
    if(Utils::currentUserRoleCode() == "G0003")
        s = "VALIDE";
...
void UIFacturesListView2::slotRejeter(const QModelIndex &index)
{
    if(MessageBox::question(this)){
...
void UIFacturesListView2::on_tableView_clicked(const QModelIndex &index)
{
